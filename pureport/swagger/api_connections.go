...
@return Connection
*/
func (a *ConnectionsApiService) Delete9(ctx context.Context, connectionId string) (Connection, *http.Response, error) {
	var (
...
@return Connection
*/
func (a *ConnectionsApiService) Get11(ctx context.Context, connectionId string) (Connection, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
