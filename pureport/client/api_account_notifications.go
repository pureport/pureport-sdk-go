...
// AccountNotificationsApiService AccountNotificationsApi service
type AccountNotificationsApiService service

// FindAccountNotificationsOpts Optional parameters for the method 'FindAccountNotifications'
...
/*
FindAccountNotifications Retrieve all notifications for this account
...
func (a *AccountNotificationsApiService) FindAccountNotifications(ctx _context.Context, accountId string, localVarOptionals *FindAccountNotificationsOpts) ([]AccountNotification, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  []AccountNotification
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/accounts/{accountId}/notifications"
...
// UpdateAccountNotificationsStatusOpts Optional parameters for the method 'UpdateAccountNotificationsStatus'
type UpdateAccountNotificationsStatusOpts struct {
	RequestBody optional.Interface
}

/*
UpdateAccountNotificationsStatus Update an authenticated user's read status for account notifications
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
