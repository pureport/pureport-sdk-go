...
/*
GetInternal Get internal connection details
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param connectionId
@return Connection
*/
func (a *ConnectionsApiService) GetInternal(ctx _context.Context, connectionId string) (interface{}, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/connections/{connectionId}/details"
	localVarPath = strings.Replace(localVarPath, "{"+"connectionId"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", connectionId)), -1)
...
/*
RespawnConnection Respawn connection
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param connectionId
@return Connection
*/
func (a *ConnectionsApiService) RespawnConnection(ctx _context.Context, connectionId string) (interface{}, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/connections/{connectionId}/respawn"
	localVarPath = strings.Replace(localVarPath, "{"+"connectionId"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", connectionId)), -1)
