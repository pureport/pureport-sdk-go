...
**CustomerASN** | **int64** | The customer side ASN. This can either be a public or private ASN. If this is a public ASN, you must own it to prevent conflicts. | 
...
**ServiceUUID** | **string** | The Equinix service UUID for the connection. | 
